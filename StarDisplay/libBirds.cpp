...
void luaopen_libBirds(lua_State* L)
{
  module(L)[
    ...
    class_<CPredator::hunt>("__predhunt")
	  ...
	  .def_readonly("DPAdjParam", &CPredator::hunt::DPAdjParam)
	  .def_readonly("N", &CPredator::hunt::N)
	  .def_readonly("startAltitude", &CPredator::hunt::startAltitude)
	  .def_readonly("startXdist", &CPredator::hunt::startXdist)

...
local Default = {
  ...
  Ruler = {
    ...
    evolution = {
		...
		evolveZ= false,
		evolveCL= false,
		evolvewingAspectRatio= false,
		evolvewingBeatFreq= false,
		evolvetheta= false,
		evolvewingLength= false,
		evolvebodyArea= false,
		evolvecBody= false,
		evolvecFriction= false,
		evolvemaxForce= false,
		evolvewingSpan= false,
		evolvebodyMass= false,
		evolvewingMass= false,
		evolveInertiaWing= false,
		evolveInertiaBody= false,
		evolveJ= false,
		...
		evolvecohesionWeight= false,
		evolveHandleTime= false,
		evolveLockDistance= false,
